`timescale 1 ns / 1 ps
//////////////////////////////////////////////////////////////////////////////////
// 파일 : fault_manager_ip_v1_0.v
// 역할 : IP 최상위. 마법사 생성 top 을 대체한다.
//        Block Design 에서 보이는 포트가 여기서 결정된다.
//
// Block Design 연결
//   timeout[2:0]        <- heartbeat_monitor_ip 의 timeout[2:0]
//   error_flag[2:0]     <- AXI GPIO 또는 보드 스위치 (Fault Injection)
//   critical_fault[2:0] <- AXI GPIO 또는 보드 스위치 (Device 2 가 기본 Critical)
//   eval_tick           <- 공통 eval_tick_generator.v 의 eval_tick (00 문서 5.2).
//                          safety_controller_ip.eval_tick 과 같은 소스를 쓴다.
//   fault_level[1:0]    -> safety_controller_ip 의 fault_level
//   fault_device[1:0]   -> safety_controller_ip
//   fault_code[7:0]     -> safety_controller_ip (필요 시)
//   fault_valid         -> safety_controller_ip
//   irq                 -> xlconcat -> AXI INTC
//////////////////////////////////////////////////////////////////////////////////

module fault_manager_ip_v1_0 #
(
...
(
    ...
    ) fault_manager_ip_v1_0_S00_AXI_inst (
        .timeout            (timeout),
